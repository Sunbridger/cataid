  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="sticky top-0 bg-white/95 backdrop-blur-sm z-30 px-4 py-3 flex items-center shadow-sm border-b border-slate-100 -mx-4">
        ...
        <h1 className="flex-1 text-center text-lg font-bold text-slate-800 pr-10">我的收藏</h1>
      </div>

      <div className="max-w-4xl mx-auto py-6">
        {favorites.length === 0 ? (
          <div className="bg-white rounded-3xl p-8 text-center shadow-sm border border-slate-100 max-w-md mx-auto">
